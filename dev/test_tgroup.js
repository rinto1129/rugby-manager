...
document.getElementById('ewg-tue').checked=false;
document.getElementById('ewg-thu').checked=true;
...
ok('wg保存',t.wg&&t.wg.f5.length===2&&t.wg.f5.indexOf('mon')>=0&&t.wg.f5.indexOf('thu')>=0);
